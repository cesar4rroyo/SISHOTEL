...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Edit rol #{{ $rol->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/rol/' . $rol->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
