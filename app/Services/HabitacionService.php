...
class HabitacionService extends InitService implements CRUDInterfaceService

{
    public function __construct()
    {
        $this->modelo = new Habitacion();
        $this->entity = 'habitacion';
        $this->folderview = 'habitacion.habitacion';
        $this->tituloAdmin = 'Habitación';
        ...
        $this->rutas = [
            ...
            'store' => 'habitacion.store',
            'delete' => 'habitacion.eliminar',
            'create' => 'habitacion.create',
            'edit' => 'habitacion.edit',
            'update' => 'habitacion.update',
            'destroy' => 'habitacion.destroy',
        ];
    ...
    public function searchService(Request $request)
    {
        ...
        $numero = Libreria::getParam($request->get('numero'));
        $piso = Libreria::getParam($request->get('piso'));
        $tipohabitacion = Libreria::getParam($request->get('tipohabitacion'));

        //BUSCAR EN EL MODELOS
        $resultado = $this->modelo::listar($numero, $piso, $tipohabitacion);
        $lista = $resultado->get();
    ...
    public function indexService()
    {
        return view($this->folderview . '.index')->with([
            ...
            'ruta' => $this->rutas,
            'cboPisos' => $this->clsLibreria->generateCboGeneral(Piso::class, 'nombre', 'id', 'Todos'),
            'cboTiposHabitacion' => $this->clsLibreria->generateCboGeneral(TipoHabitacion::class, 'nombre', 'id', 'Todos'),
